...
lazy val buildActionFileReceiverUploadAssembly = taskKey[Unit]("Upload Jar via HTTP PUT to File Receiver")
buildActionFileReceiverUploadAssembly := Def.taskDyn {
...
lazy val buildActionFileReceiverUploadGraalNative = taskKey[Unit]("Upload Graal Native via HTTP PUT to File Receiver")
buildActionFileReceiverUploadGraalNative := Def.taskDyn {
...
lazy val buildActionFileReceiverUploadScalaNative = taskKey[Unit]("Upload Scala Native via HTTP PUT to File Receiver")
buildActionFileReceiverUploadScalaNative := Def.taskDyn {
